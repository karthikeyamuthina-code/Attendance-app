...
//   return (
//     <div className={cn("w-64 bg-sidebar text-sidebar-foreground", className)}>
//       {children}
//     </div>
//   );
// };
...
//   <div className={cn("flex flex-col p-2 gap-2", className)} {...props} />
// );
...
//         ref={ref}
//         className={cn(
//           "flex items-center gap-2 p-2 rounded-md text-sm hover:bg-accent hover:text-accent-foreground",
//           className
//         )}
//         {...props}
//       />
